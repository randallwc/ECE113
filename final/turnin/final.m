...
fcuts1 = [Fpass1 Fstop11]; 
fcuts2 = [Fpass1 Fstop12];
fcuts3 = [Fpass21 Fstop21];
fcuts4 = [Fpass22 Fstop22];
...
[n11,Wn1,beta1,ftype1] = kaiserord(fcuts1, mags, dev, Fs);
[n12,Wn2,beta2,ftype2] = kaiserord(fcuts2, mags, dev, Fs);
[n13,Wn3,beta3,ftype3] = kaiserord(fcuts3, mags, dev, Fs);
[n14,Wn4,beta4,ftype4] = kaiserord(fcuts4, mags, dev, Fs);
...
hn11 = fir1(n11, Wn1, ftype1, kaiser(n11+1, beta1), "noscale");
hn12 = fir1(n12, Wn2, ftype2, kaiser(n12+1, beta2), "noscale");
hn13 = fir1(n13, Wn3, ftype3, kaiser(n13+1, beta3), "noscale");
hn14 = fir1(n14, Wn4, ftype4, kaiser(n14+1, beta4), "noscale");
...
[n21,fo1,ao1,w1] = firpmord(fcuts1, mags, dev, Fs);
[n22,fo2,ao2,w2] = firpmord(fcuts2, mags, dev, Fs);
[n23,fo3,ao3,w3] = firpmord(fcuts3, mags, dev, Fs);
[n24,fo4,ao4,w4] = firpmord(fcuts4, mags, dev, Fs);
...
hn21 = firpm(n21, fo1, ao1, w1);
hn22 = firpm(n22, fo2, ao2, w2);
hn23 = firpm(n23, fo3, ao3, w3);
hn24 = firpm(n24, fo4, ao4, w4);
...
H11=freqz(hn11,1,F,Fs);
H12=freqz(hn12,1,F,Fs);
H21=freqz(hn21,1,F,Fs);
H22=freqz(hn22,1,F,Fs);

% For filters 3 and 4 (different passband, same transition bandwidths)
% using Kaiser window and Parks-McClellan
% Use freqz command with frequency in Hz, i.e., H = freqz(...,F,Fs)

H13=freqz(hn13,1,F,Fs);
H14=freqz(hn14,1,F,Fs);
H23=freqz(hn23,1,F,Fs);
H24=freqz(hn24,1,F,Fs);
...
Fp3 = Fpass21; % Fpass21 = 100e3; Passband cutoff for Filter 3
Fs3 = Fstop21; % Fstop21 = 200e3; Stopband cutoff for Filter 3

% https://www.mathworks.com/help/signal/ref/cheb2ord.html
% Use cheb2ord to find the minimum Chebyshev Type II filter order given the specs
[n33,ws] = cheb2ord(Fp3/Fs * 2,Fs3/Fs * 2,Rp,Rs);

% Use cheby2 to design the Chebyshev Type II filter using the order and cutoff
% you found above
[b33,a33] = cheby2(n33,Rs,ws);

% https://www.mathworks.com/help/signal/ref/ellipord.html
% Use ellipord to find the minimum Elliptic filter order given the specs
[n43,wp] = ellipord(Fp3/Fs * 2,Fs3/Fs * 2,Rp,Rs);

% https://www.mathworks.com/help/signal/ref/ellip.html
% Use ellip to design the Elliptic filter using the order and cutoff
% you found above
[b43,a43] = ellip(n43,Rp,Rs,wp);
...
H33 = freqz(b33,a33,F,Fs);         % Chebyshev Type II
H43 = freqz(b43,a43,F,Fs);         % Elliptic
